...
<main>
	...
	<section class="flex h-fit w-full flex-col-reverse bg-a-green-bg xl:flex-row">
		{#if $selectedChapter === 0}
			<div
				class="flex h-fit w-full flex-col items-center justify-center bg-white p-14 xl:h-[800px] xl:w-[800px] xl:border-r-2 xl:border-r-a-green-hover/50"
			>
				<div class="mb-10 flex items-center justify-center">
					<svg
						width="40px"
						height="40px"
						class="mr-5 fill-a-red"
						...
						/></svg
					>
					<h1 class="text-center text-5xl font-bold text-a-red">Bay Area, CA</h1>
				</div>
			...
			>
				<div class=" mb-5 flex items-center justify-center">
					<svg
						...
						/></svg
					>
					<h1 class=" text-center text-5xl font-bold text-a-black">
				...
				<button
					class="mt-5 w-fit rounded-3xl border-2 border-a-red bg-a-red px-4 text-lg text-white transition-all hover:border-a-red-hover hover:bg-a-red-hover active:translate-y-0.5"
